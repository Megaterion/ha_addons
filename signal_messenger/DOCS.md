...
Bug reports can be filed either with the [add-on repository](https://github.com/megaterion/ha_addons), or with the [upstream repository](https://github.com/bbernhard/signal-cli-rest-api). 
